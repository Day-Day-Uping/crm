                ...
                <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                    ...
                    <#if permissions?seq_contains("10")>
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <#if permissions?seq_contains("1010")><dd>
                                ...
                                <#if permissions?seq_contains("1020")><dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                    ...
                    <#if permissions?seq_contains("30")>
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <#if permissions?seq_contains("3010")><dd>
                                ...
                                <#if permissions?seq_contains("3020")><dd>
                                ...
                                <#if permissions?seq_contains("3030")><dd>
                                ...
                                <#if permissions?seq_contains("3040")><dd>
                                ...
                                <#if permissions?seq_contains("3050")><dd>
                    ...
                    <#if permissions?seq_contains("40")>
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <#if permissions?seq_contains("4040")><dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <#if permissions?seq_contains("5010")><dd>
                                <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
